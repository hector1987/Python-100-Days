...
> 
> **説明**：プロジェクトを公開してから80,000スターを獲得して以来，ずっと基礎部分（Day01-15の内容）は新人にとって比較的困難で、解説動画でサポートしてくださいとの提案があります。最近基礎部分の内容を、改めて[“Python-Core-50-Courses”](<https://github.com/jackfrued/Python-Core-50-Courses>)という名前のプロジェクトを作成し、**用更为简单通俗的方式重写了这部分内容并附带了视频讲解**，初学者可以关注下这个新项目。国内用户如果访问GitHub比较慢的话，也可以关注我的知乎号[Python-Jack](https://www.zhihu.com/people/jackfrued)上的[“从零开始学Python”](<https://zhuanlan.zhihu.com/c_1216656665569013760>)专栏，专栏会持续更新，还有大家比较期待的“数据分析”的内容也即将上线，**欢迎大家关注我在知乎的专栏、文章和回答**。
...
簡単に言えば、Pythonは”優雅（エレガント）”、”明確”、”簡単”なプログラム言語です。
